...
$(function() {$('.pj_index_close').click(function() {$('.pj-index-1').removeClass('active');$('.pj-sam-1').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-2').removeClass('active');$('.pj-sam-2').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-3').removeClass('active');$('.pj-sam-3').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-4').removeClass('active');$('.pj-sam-4').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-5').removeClass('active');$('.pj-sam-5').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-6').removeClass('active');$('.pj-sam-6').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-7').removeClass('active');$('.pj-sam-7').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-8').removeClass('active');$('.pj-sam-8').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-9').removeClass('active');$('.pj-sam-9').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-10').removeClass('active');$('.pj-sam-10').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-11').removeClass('active');$('.pj-sam-11').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-12').removeClass('active');$('.pj-sam-12').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-13').removeClass('active');$('.pj-sam-13').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-14').removeClass('active');$('.pj-sam-14').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-15').removeClass('active');$('.pj-sam-15').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-16').removeClass('active');$('.pj-sam-16').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-17').removeClass('active');$('.pj-sam-17').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-18').removeClass('active');$('.pj-sam-18').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-19').removeClass('active');$('.pj-sam-19').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-20').removeClass('active');$('.pj-sam-20').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-21').removeClass('active');$('.pj-sam-21').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-22').removeClass('active');$('.pj-sam-22').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-23').removeClass('active');$('.pj-sam-23').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-24').removeClass('active');$('.pj-sam-24').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-25').removeClass('active');$('.pj-sam-25').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-26').removeClass('active');$('.pj-sam-26').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-27').removeClass('active');$('.pj-sam-27').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-28').removeClass('active');$('.pj-sam-28').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-29').removeClass('active');$('.pj-sam-29').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-30').removeClass('active');$('.pj-sam-30').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-31').removeClass('active');$('.pj-sam-31').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-32').removeClass('active');$('.pj-sam-32').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-33').removeClass('active');$('.pj-sam-33').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-34').removeClass('active');$('.pj-sam-34').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-35').removeClass('active');$('.pj-sam-35').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-36').removeClass('active');$('.pj-sam-36').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-37').removeClass('active');$('.pj-sam-37').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-38').removeClass('active');$('.pj-sam-38').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-39').removeClass('active');$('.pj-sam-39').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-40').removeClass('active');$('.pj-sam-40').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-41').removeClass('active');$('.pj-sam-41').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-42').removeClass('active');$('.pj-sam-42').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-43').removeClass('active');$('.pj-sam-43').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-44').removeClass('active');$('.pj-sam-44').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-45').removeClass('active');$('.pj-sam-45').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-46').removeClass('active');$('.pj-sam-46').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-47').removeClass('active');$('.pj-sam-47').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-48').removeClass('active');$('.pj-sam-48').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-49').removeClass('active');$('.pj-sam-49').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-50').removeClass('active');$('.pj-sam-50').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-51').removeClass('active');$('.pj-sam-51').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-52').removeClass('active');$('.pj-sam-52').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-53').removeClass('active');$('.pj-sam-53').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-54').removeClass('active');$('.pj-sam-54').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-55').removeClass('active');$('.pj-sam-55').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-56').removeClass('active');$('.pj-sam-56').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-57').removeClass('active');$('.pj-sam-57').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-58').removeClass('active');$('.pj-sam-58').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-59').removeClass('active');$('.pj-sam-59').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-60').removeClass('active');$('.pj-sam-60').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-61').removeClass('active');$('.pj-sam-61').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-62').removeClass('active');$('.pj-sam-62').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-63').removeClass('active');$('.pj-sam-63').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-64').removeClass('active');$('.pj-sam-64').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-65').removeClass('active');$('.pj-sam-65').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-66').removeClass('active');$('.pj-sam-66').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-67').removeClass('active');$('.pj-sam-67').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-68').removeClass('active');$('.pj-sam-68').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-69').removeClass('active');$('.pj-sam-69').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-70').removeClass('active');$('.pj-sam-70').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-71').removeClass('active');$('.pj-sam-71').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-72').removeClass('active');$('.pj-sam-72').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-73').removeClass('active');$('.pj-sam-73').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-74').removeClass('active');$('.pj-sam-74').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-75').removeClass('active');$('.pj-sam-75').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-76').removeClass('active');$('.pj-sam-76').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-77').removeClass('active');$('.pj-sam-77').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-78').removeClass('active');$('.pj-sam-78').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-79').removeClass('active');$('.pj-sam-79').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-80').removeClass('active');$('.pj-sam-80').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-81').removeClass('active');$('.pj-sam-81').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-82').removeClass('active');$('.pj-sam-82').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-83').removeClass('active');$('.pj-sam-83').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-84').removeClass('active');$('.pj-sam-84').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-85').removeClass('active');$('.pj-sam-85').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-86').removeClass('active');$('.pj-sam-86').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-87').removeClass('active');$('.pj-sam-87').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-88').removeClass('active');$('.pj-sam-88').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-89').removeClass('active');$('.pj-sam-89').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-90').removeClass('active');$('.pj-sam-90').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-91').removeClass('active');$('.pj-sam-91').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-92').removeClass('active');$('.pj-sam-92').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-93').removeClass('active');$('.pj-sam-93').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-94').removeClass('active');$('.pj-sam-94').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-95').removeClass('active');$('.pj-sam-95').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-96').removeClass('active');$('.pj-sam-96').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-97').removeClass('active');$('.pj-sam-97').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-98').removeClass('active');$('.pj-sam-98').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-99').removeClass('active');$('.pj-sam-99').removeClass('active');});});
$(function() {$('.pj_index_close').click(function() {$('.pj-index-100').removeClass('active');$('.pj-sam-100').removeClass('active');});});

$(function() {$('.pj_index_close').click(function() {$('.pj-index-100').removeClass('active');$('.s-readmore-index').removeClass('active');});});
